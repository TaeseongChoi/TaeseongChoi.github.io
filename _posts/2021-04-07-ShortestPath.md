...
>#### 결과값
```java
0번 노드에서 0번 노드까지 가는 최단거리: 0
0번 노드에서 1번 노드까지 가는 최단거리: 12
0번 노드에서 2번 노드까지 가는 최단거리: 15
0번 노드에서 3번 노드까지 가는 최단거리: 36
0번 노드에서 4번 노드까지 가는 최단거리: 16
0번 노드에서 5번 노드까지 가는 최단거리: 19
0번 노드에서 6번 노드까지 가는 최단거리: 22
0번 노드에서 7번 노드까지 가는 최단거리: 36
0번 노드에서 8번 노드까지 가는 최단거리: 29
0번 노드에서 9번 노드까지 가는 최단거리: 31
수행시간 : 27ms
```